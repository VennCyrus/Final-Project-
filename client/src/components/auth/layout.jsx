...
function AuthLayout() {
    ...
    const fullText = "Welcome to the Furniture Haven for Home Lovers!";
    ...
    return (
        <div className="flex min-h-screen w-full">
            <div
                ...
                style={{
                    backgroundImage: "url('https://contentgrid.homedepot-static.com/hdus/en_US/DTCCOMNEW/Articles/best-furniture-for-your-home-2022-hero.jpg')",
                    // backgroundImage: "url('https://hips.hearstapps.com/hmg-prod/images/universal-furniture-custom-furniture-1663173971.jpg')",
